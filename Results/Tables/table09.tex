\begin{table*}[t]
\centering
\caption{Conditional guarantees under compromise and collusion in proof-per-action mode}
\begin{tabular}{lll}
\hline
...
Fewer than t\_Y authorities & quorum authenticity and collusion resistance & availability if honest members refuse service \\
