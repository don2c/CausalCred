...
| --- | --- | --- | --- | --- | --- |
| T01 | Table 1 | Approach positioning | data/reported/manuscript_tables.json | results/tables/table01.csv, .md, .tex | make reproduce |
| T02 | Table 2 | Core notation | data/reported/manuscript_tables.json | results/tables/table02.csv, .md, .tex | make reproduce |
| T03 | Table 3 | Post-quantum profile | data/reported/manuscript_tables.json | results/tables/table03.csv, .md, .tex | make reproduce |
| T04 | Table 4 | Cloud baseline UER and Wilson intervals | data/manuscript_derived/cloud_baseline_trials.csv | results/tables/table04.csv, .md, .tex | make reproduce |
| T05 | Table 5 | Per-operation cost and memory | data/reported/manuscript_tables.json | results/tables/table05.csv, .md, .tex | make reproduce |
| T06 | Table 6 | Cryptographic profile comparison | data/reported/manuscript_tables.json | results/tables/table06.csv, .md, .tex | make reproduce |
| T07 | Table 7 | Supply-chain attack results | data/manuscript_derived/causalcred_attack_trials.csv; data/manuscript_derived/supply_chain_digest_subset.csv | results/tables/table07.csv, .md, .tex | make reproduce |
| T08 | Table 8 | Single-control ablations | data/manuscript_derived/cloud_ablation_trials.csv | results/tables/table08.csv, .md, .tex | make reproduce |
| T09 | Table 9 | Compromise and collusion boundaries | data/reported/manuscript_tables.json | results/tables/table09.csv, .md, .tex | make reproduce |
| T10 | Table 10 | Trial configuration | data/reported/manuscript_tables.json | results/tables/table10.csv, .md, .tex | make reproduce |
| T11 | Table 11 | Instruction decomposition and bound terms | data/reported/manuscript_tables.json | results/tables/table11.csv, .md, .tex | make reproduce |
| T12 | Table 12 | Scaling matrix | data/reported/manuscript_tables.json | results/tables/table12.csv, .md, .tex | make reproduce |
| T13 | Table 13 | Attack-to-property mapping | data/reported/manuscript_tables.json | results/tables/table13.csv, .md, .tex | make reproduce |
